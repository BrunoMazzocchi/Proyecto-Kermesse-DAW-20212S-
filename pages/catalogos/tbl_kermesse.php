...
<body class="hold-transition sidebar-mini">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $r->__GET('nombreParroquia') ?></td>
                  ...
                  <td> <a href="frm_editar_kermesse.php?editC=<?php echo $r->__GET('id_kermesse'); ?>" target="blank">
                    ...
                    &nbsp;&nbsp;
                    <a href="#" onclick="deleteKermesse(<?php echo $r->__GET('id_kermesse'); ?>);">
  ...
  <script>
    function deleteKermesse(id) {
      confirm(function(e, btn) {
          e.preventDefault();
          window.location.href = "../../negocio/ng_Kermesse.php?delK=" + id;
        },
        function(e, btn) {
          e.preventDefault();
        });
