                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Lista Bonos</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form>
                                <div class="form-group">
                    <label> ID Control Bono </label>
                    <input type="number" class="form-control" id="id_control_bono" name= "id_control_bono"  maxlenght= "2"
                    placeholder="ID Control Bono"  required>
                  </div>

                  <div class="form-group">
                    <label>Nombre</label>
                    <input type="text" class="form-control" id="nombre" name= "nombre"  maxlenght= "45"
                    placeholder="Ingrese el nombre del Bono" title= "INombre" required>
                  </div>

                  <div class="form-group">
                    <label>Valor</label>
                    <input type="number" class="form-control" id="valor" name= "valor" step="any" maxlenght= "10"
