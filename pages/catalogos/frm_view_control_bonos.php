...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1> View Listas Bonos</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                <li class="breadcrumb-item active">Lista Bonos</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                ...
                                <form>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>ID Bono</label>
                                            <input readonly type="number" value="<?php echo $bono->__GET('id_bono');?>" class="form-control" id="id_bono" name="id_bono" placeholder="ID Bono" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Nombre</label>
                                            <input readonly type="text" value="<?php echo $bono->__GET('nombre');?>" class="form-control" id="nombre" name="nombre" placeholder="Nombre" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Valor</label>
                                            <input readonly type="number" value="<?php echo $bono->__GET('valor');?>" class="form-control" id="valor" name="valor" placeholder="Valor" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Estado</label>
                                            <input readonly type="text" value="<?php echo $bono->__GET('estado');?>" class="form-control" id="estado" name="estado" placeholder="Estado" required>
                                        </div>
                                    </div>
    ...
    <script>
      ...
      $("#estado").val("<?php echo $bono->__GET('estado') ?>")
    }
