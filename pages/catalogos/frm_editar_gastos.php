...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select name="idCatGastos" id="idCatGastos" class="form-control" required>
                          <option id="idCatGastos" value="">Categoria</option>
  ...
  <script>
    function setValoresGast() {
      ...
      $("#idKermesse").val("<?php echo $gast->__GET('idKermesse') ?>")
      $("#concepto").val("<?php echo $gast->__GET('concepto') ?>")
      $("#monto").val("<?php echo $gast->__GET('monto') ?>")
      $("#idCatGastos").val("<?php echo $gast->__GET('idCatGastos') ?>")
