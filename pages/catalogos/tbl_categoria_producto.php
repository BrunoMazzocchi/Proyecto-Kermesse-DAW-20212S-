...
<head>
    ...
    <title>KERMESSE | Tabla Categoria Productos  </title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Tabla Categoria Productos</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"> Tabla Categoria Productos</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        foreach($dtcp->listCategoriaProducto() as $r):
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="frm_editar_categoria_producto.php?editCg=<?php echo $r->__GET('id_categoria_producto'); ?>" target="blank">
                                            <i class="far fa-edit" title="Editar Categoria"></i></a>
                                        &nbsp;&nbsp;
                                        <a href="frm_view_categoria_producto.php?viewCyG=<?php echo $r->__GET('id_categoria_producto'); ?>" target="blank">
