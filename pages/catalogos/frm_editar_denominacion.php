            ...
            <div class="card card-primary">
              ...
              <form>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="id_Denominacion" name="id_Denominacion" placeholder="ID Denominacion">
                  </div>
                    <label>ID Moneda</label>
                    <input type="text" class="form-control" id="idMoneda" name="idMoneda"placeholder="Digite el ID de la Moneda">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="valor_letras" name="valor_letras" placeholder="Valor">
                  </div>
                </div>
                <!-- /.card-body -->
...
$("#id_categoria_gastos").val("<?php echo $cat-> _GET('id_categoria_gastos')?>");
$("#nombre_categoria").val("<?php echo $cat-> _GET('nombre_categoria')?>");
$("#descripcion").val("<?php echo $cat-> _GET('descripcion')?>");
