            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    placeholder="Ingrese el nombre del Bono" title= "Ingrese el nombre del Bono" required>
                  </div>

                  <div class="form-group">
                    <label>Valor</label>
                    <input type="number" class="form-control" id="valor" name= "valor" step="any" maxlenght= "10"
                    placeholder="Ingrese el valor del Bono" title= "Ingrese el valor del Bono" required>
                  </div>
