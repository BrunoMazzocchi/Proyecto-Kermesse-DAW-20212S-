              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" value="<?php echo $tasacambioDet->_GET('id_tasaCambio_det'); ?>" class="form-control" id="id_tasaCambio_det" name="id_tasaCambio_det"placeholder="" disabled>
                  </div>
                  <div class="form-group">
                    <label>ID Tasa Cambio </label>
                    <input type="text" value="<?php echo $tasacambioDet->_GET('id_tasaCambio'); ?>" class="form-control" id="id_tasaCambio" name="id_tasaCambio"placeholder="" disabled>
                  </div>
                  <div class="form-group">
                    <label>Fecha</label>
                    <input type="date" value="<?php echo $tasacambioDet->_GET('fecha'); ?>" class="form-control" id="fecha" name="fecha"placeholder="" disabled>
                  </div>
                  <div class="form-group">
                    <label>Tipo de Cambio</label>
                    <input type="decimal" value="<?php echo $tasacambioDet->_GET('tipoCambio'); ?>" class="form-control" id="tipoCambio" name="tipoCambio"placeholder="" disabled>
                  </div>
                </div>
                <!-- /.card-body -->
              </form>
