...
<head>
    ...
    <title>KERMESSE | Tabla Control de bonos</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        foreach($dtcb->listarControlBonos() as $r):
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $r->__GET('estado_');?></td>
                                        <td> <a href="frm_editar_control_bonos.php?editCg=<?php echo $r->__GET('id_control_bonos'); ?>" target="blank">
                                            <i class="far fa-edit" title="Editar Categoria"></i></a>
                                        &nbsp;&nbsp;
                                        <a href="frm_view_control_bonos.php?viewCyG=<?php echo $r->__GET('id_control_bonos'); ?>" target="blank">
                                            <i class="far fa-eye" title="Ver Bonos"></i></a>
                                        &nbsp;&nbsp;
