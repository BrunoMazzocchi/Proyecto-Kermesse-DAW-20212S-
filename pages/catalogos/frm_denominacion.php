  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Nueva Denominacion</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="tbl_denominacion.php">Inicio</a></li>
                <li class="breadcrumb-item active">Registrar Denominacion</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Registrar denominacion de moneda</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
              <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="idMoneda" name="idMoneda" placeholder="ID Moneda" required>
                    </div>
                    <div class="form-group">
                      <label>Valor</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="valor_letras" name="valor_letras" placeholder="Valor en letras" required>
                    </div>
                  </div>
